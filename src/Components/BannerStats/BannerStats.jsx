    ...
    return (
        <div>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                {/*==== left card ====*/}
                <div className="col-span-1 bg-[#FBFBFB] border rounded-[24px]">
                ...
                <div className="col-span-1 md:col-span-3">
                    ...
                    <div className=''>
                        ...
                        <div className='grid grid-cols-3 gap-3'>
                            ...
                            <div className='bg-[#FBFBFB] border rounded-3xl'>
                                <div className='flex'>
                ...
                <div className="col-span-1 bg-[#FBFBFB] border-2 rounded-[24px]">
